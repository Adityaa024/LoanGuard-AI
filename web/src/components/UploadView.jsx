            ...
            >
              ...
              {!file ? (
                <div className="flex flex-col items-center">
                  ...
                  <div className="text-sm font-semibold text-slate-800">Choose a CSV file or drag it here</div>
                  <div className="text-xs text-slate-400 mt-1">Supports standard loan tape formats up to 12MB</div>
                </div>
              ) : (
                <div className="w-full flex flex-col items-center">
                  ...
                  <div className="text-sm font-bold text-slate-900 font-mono truncate max-w-full px-2">
                    {file.name}
                  </div>
                  ...
                  <button 
                    className="text-xs font-semibold text-rose-600 hover:text-rose-700 bg-rose-50 hover:bg-rose-100 px-3 py-1 rounded-lg transition-colors flex items-center gap-1.5" 
            ...
            >
              {uploading ? (
                <>
                  ...
                  <span>Ingesting & Checking Policies...</span>
                </>
              ) : (
                <>
                  <Zap className="w-4 h-4" />
                  <span>Start Validation Pipeline</span>
                </>
              )}
            </button>
              ...
              <div className="mt-4 p-3.5 bg-emerald-50 border border-emerald-200 rounded-xl">
                ...
                <div className="grid grid-cols-3 gap-2 text-center text-xs">
                  <div className="bg-white p-2 rounded-lg border border-slate-100 shadow-xs">
                    ...
                    <div className="font-mono font-bold text-slate-800 mt-0.5">{result.recordsProcessed}</div>
                  </div>
                  <div className="bg-white p-2 rounded-lg border border-emerald-100 shadow-xs">
                    ...
                    <div className="font-mono font-bold text-emerald-700 mt-0.5">{result.validCount}</div>
                  </div>
                  <div className="bg-white p-2 rounded-lg border border-amber-100 shadow-xs">
                    <div className="text-[10px] text-amber-600 uppercase font-semibold">Exceptions</div>
            ...
            {result && result.error && (
              <div className="mt-4 p-3.5 bg-rose-50 border border-rose-200 rounded-xl text-xs">
                <div className="text-rose-800 font-bold flex items-center gap-1.5 mb-1">
                  ...
                  <span>Ingestion Rejected</span>
                </div>
                <div className="font-mono text-rose-700 bg-white p-2 rounded border border-rose-100 mt-1.5 break-all">
                  {result.error}
                </div>
              </div>
            )}
          ...
          <div className="saas-card p-4 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
              <button 
                ...
                className="btn-secondary text-xs py-2 px-2.5 text-left justify-start group"
              >
              ...
              <button 
                ...
                className="btn-secondary text-xs py-2 px-2.5 text-left justify-start group border-indigo-200 bg-indigo-50/40 hover:bg-indigo-50"
              >
                <Database className="w-3.5 h-3.5 text-indigo-600 shrink-0" />
                <div className="truncate">
                  <div className="font-semibold text-indigo-950 text-[11px]">Large 3k Tape</div>
                  <div className="text-[10px] text-indigo-500">Stress & Torture</div>
                </div>
              </button>
            </div>
          </div>

          {/* Exception Severity Donut Chart */}
