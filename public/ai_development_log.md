...
2. `loans`: Canonical representation storing 30+ fields (loan_id, borrower_name, property_address, principal_balance, interest_rate, origination_date, maturity_date, payment_status, days_past_due, document_status, source_system, validation_status, is_verified, verified_at, verified_by, verified_hash).
